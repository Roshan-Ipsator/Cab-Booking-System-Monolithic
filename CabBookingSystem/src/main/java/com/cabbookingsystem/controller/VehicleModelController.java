...
public class VehicleModelController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse> addVehicleModel(@Valid @RequestBody VehicleModel vehicleModel) {
		return vehicleModelService.addVehicleModel(vehicleModel).finalResponse();
	}
